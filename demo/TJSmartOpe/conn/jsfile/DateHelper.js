function fPopUpCalendarDlg(ctrlobj)
{
	...
	ctrlobj.select();
	retval = ShowModalDialog("/conn/jsfile/calendar.htm?a=" + new Date(), ctrlobj, "dialogWidth:197px; dialogHeight:"+dlgheight+"px; dialogLeft:"+showx+"px; dialogTop:"+showy+"px; status:no; directories:yes;scrollbars:no;Resizable=no; ");
	if( retval != null )
