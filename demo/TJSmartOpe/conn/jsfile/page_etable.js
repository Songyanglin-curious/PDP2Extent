...
function page_etable(arrCellType,arrRowContent,privnoedit)
{
    ...
    document.write("<center><table border='0' style='margin:0;font-size:10pt;width:99%'"
        ...
        + "'><tr><td><div class='pageFootLeft'/></td><td class='pageFootCenter'><a href='javascript:void(0)' onclick='return eTable_findTableById("
        ...
        + this._etable._table.id + ").turntoPage()'>跳转</a></td><td><div class='pageFootRight' /></td></tr></table></center>");
    ...
    this._etable.cancelRow = function (obj) {
        var tr = obj.parentElement.parentElement;
        if (this._RowContents.length == this._pagenum * this._pagerow + tr.rowIndex - 1 || tr.rowIndex == this._table.rows.length - 1)
            return;
        var rowContent = this._RowContents[this._pagenum * this._pagerow + tr.rowIndex - 1];
