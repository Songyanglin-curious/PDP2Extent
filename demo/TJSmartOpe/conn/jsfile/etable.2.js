// JScript 文件
//导入css文件
document.write("<link type='text/css' rel='Stylesheet' href='/conn/cssfile/EditTable.css' />");
...
function etable(arrCellType,arrRowContent,privnoedit)
{
    ...
    this.contentRow = function(arrRowContent)
    {
        ...
        for(var i = 0; i < this._RowContents.length; i++)
        {
            ...
            tc.innerHTML = "<button style='width:52px;height:22px;border:0;' onclick='return eTable_findTableById("
                ...
                + "><img src='/i/an_bj.jpg' /></button><button style='width:52px;height:22px;border:0;'"
                + " onclick='return eTable_findTableById(" + this._table.id + ").deleteRow(this)' "
                + (this._RowContents[i]._editing ? "style='display:none'" : "") + "><img src='/i/an_sc.jpg' /></button>"
                ...
                + "> <img src='/i/an_gx.jpg' /></button><button style='width:52px;height:22px;border:0;'"
                + " onclick='return eTable_findTableById(" + this._table.id + ").cancelRow(this)' "
                + (this._RowContents[i]._editing ? "" : "style='display:none'") + "><img src='/i/an_qx.jpg' /></button>";
            tc.className="edittabletd";
            if(!this._privforedit) tc.style.display = "none";
        }
        this.insertRow(-1);
    ...
    this.insertRow = function()
    {
        ...
        tc.innerHTML = "<button style='width:52px;height:22px;border:0;' onclick='return eTable_findTableById(" + this._table.id
                    + ").editRow(this)' style='display:none'> <img src='/i/an_bj.jpg' /></button><button style='width:52px;height:22px;border:0;' onclick='return "
                    + "eTable_findTableById(" + this._table.id + ").deleteRow(this)' style='display:none'> <img src='/i/an_sc.jpg' /> </button>"
                    + "<button style='width:52px;height:22px;border:0;' onclick='return eTable_findTableById(" + this._table.id
                    + ").updateRow(this)'> <img src='/i/an_gx.jpg' /></button><button style='width:52px;height:22px;border:0;' onclick='return "
                    + "eTable_findTableById(" + this._table.id + ").cancelRow(this)'> <img src='/i/an_qx.jpg' /> </button>";
