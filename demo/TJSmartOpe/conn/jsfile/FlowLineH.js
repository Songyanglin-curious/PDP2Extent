...
function FlowLine() {
    ...
    this.NewNode = function () {
        ...
        node.GetActionVML = function (n0, n1) {
            var nTextWidth = 200;
            var nTextHeight = 90;
            var xStart = n0.x + parseInt(n0.width, 10);
            var yStart = n0.y + parseInt(n0.height, 10) / 2;
            var xEnd = n1.x;
            var yEnd = n1.y + parseInt(n1.height, 10) / 2;
            var pts = [xStart, yStart, xStart + nTextWidth, yStart, xStart + nTextWidth, yEnd, xEnd, yEnd];
            if (yStart < yEnd) {
                pts[5] -= 5;
                pts[7] -= 5;
            } else if (yStart > yEnd) {
