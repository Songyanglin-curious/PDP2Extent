...
function dTree(objName) {
	...
	this.icon = {
	    root: '/i/flow_image/flowroot.png', //flow.gif
		folder			: '/i/flow_image/imgfolder.gif',
		folderOpen	: '/i/flow_image/imgfolder.gif',
		node				: '/i/flow_image/base.gif',
		empty				: '/i/flow_image/empty.gif',
		line				: '/i/flow_image/line.gif',
		join				: '/i/flow_image/join.gif',
		joinBottom	: '/i/flow_image/joinbottom.gif',
		plus				: '/i/flow_image/plus.gif',
		plusBottom	: '/i/flow_image/plusbottom.gif',
		minus				: '/i/flow_image/minus.gif',
		minusBottom	: '/i/flow_image/minusbottom.gif',
		nlPlus			: '/i/flow_image/nolines_plus.gif',
		nlMinus			: '/i/flow_image/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
