...
//			res += "<img src='" + opts.imagePath + data.icon + "' alt='' />";
            res += "<img src='" + data.icon + "' onerror='this.src=\""+ opts.imagePath + data.icon +"\"' alt='' />";
...
//				this.tree.logDebug("nodeTitle: " + nodeTitle);
                        ...
                        if(data.isColor)
                            nodeTitle = "<a href='#' style='color:red' class='" + opts.classNames.title + "'" + tooltip + ">" + data.title + "</a>";
                        else
...
//				this.span.innerHTML = this._getInnerHtml();
			...
			if( data.addClass ){
                ...
                $(this.span).children("a").css($.parseJSON("{\""+data.addClass.replace(reg1,'":"').replace(reg2,'","')+"\"}"));
			}
...
//			logMsg("isHidden:%s", isHidden);
			if( useEffects && opts.fx && (isHidden === isExpanded) ) {
                ...
                window.setTimeout(function(e , state){e.style.display=state;},duration - 40,this.ul,(( this.bExpanded || !parent ) ? "" : "none"));
			} else {
				this.ul.style.display = ( this.bExpanded || !parent ) ? "" : "none";
			}
		}
	...
	isLastSibling: function() {
		var p = this.parent;
		return !p || p.childList == null || p.childList[p.childList.length-1] === this;
	},
