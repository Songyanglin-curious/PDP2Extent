...
var SGCDB = {
    ...
    doInit: function () {
        this.tables = [
            { type: "HVDCSYS_MEMBERS", span: 60 },
            { type: "PLANTSTATIONVOLTAGE", span: 60 }, { type: "STATE", span: 60 }, { type: "GRID", span: 60 }
            , { type: "ZONEPLANT", span: 1440 }
            , { type: "ZONELINE", span: 1440 }
            , { type: "ZONESTATION", span: 1440 }
        ];
    ...
    update: function (tbl, data, callback) {
        ...
        var THIS = this;
        request.onsuccess = function (event) {
            //THIS.datasets[tbl] = data;
            if (callback) callback(); THIS.tableState[tbl] = new Date(); THIS.saveState(); THIS.setLoading(tbl, false);
        };
    ...
    startSync: function () {
        ...
        var THIS = this;
        window.setTimeout(function () { THIS.startSync(); }, 5000);
    },
    loadState: function () {
    ...
    initData: function () {
        this.worker = new Worker("/conn/jsfile/sgc/modelwork.js?v=1.21.118.1");
