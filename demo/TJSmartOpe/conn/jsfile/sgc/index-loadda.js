...
bottomMenuInst.getLinks = function () { };
    ...
    computed: {
        datalist: function () {
            ...
            for (var i = 0; i < sports.length; i++) {
                ...
                var sport = row[1];
                if (!o[sport])
                    o[sport] = { url: this.getImgUrl(sport), rows: [], css: { height: "40px" } };
...
var owgMain = new Vue({
    ...
    data: {
        menus: [
            { id: "main", name: "主界面", w: 203 },
            { id: "path", name: "供电场馆路径", w: 203 },
            { id: "green", name: "绿色电力供应", w: 203 },
            { id: "emergency", name: "应急保障", w: 203 },
            { id: "match", name: "赛程", w: 203 },
            { id: "weather", name: "天气", w: 203 },
            { id: "scene", name: "主页", w: 93, css: { position: "absolute", right: "50px", top: "50px" } },
            { id: "back", name: "返回", w: 40, css: { position: "absolute", right: "30px", top: "30px" } }
        ],
        mid: "",
        strGym: `[
        ...
        curPath: "",
        pathCityCss: { width: 225 * owg.sz + 'px' },
        pathImgCss: { width: 211 * owg.sz + 'px' },
        leftPage: "",
        argLeftPage: null,
        rightPage: "",
        argRightPage:null
    ...
    methods: {
        ...
        showPath: function (item) {
            ...
            return "/i/sgc/hbowg/menu/" + m.id + ((m.id == this.mid) ? "_focus" : "") + ".png";
        },
            ...
            getMenuStyle: function (m) {
                var css = m.css || {};
                if (m.w) css.width = (owg.sz * m.w * 1.2) + "px";
                return css;
            },
