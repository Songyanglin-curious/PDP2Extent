...
function () {
    ...
    this.hRow = parseInt(($(window.document).height() - 540*r) / 6 / r, 10) + "px";
});
var zblist='';
...
this.colClick = function (dtime) {
    ...
    owg.matchPage = vMain.floatPage("sgc_caowg_matchtime", {
                                ...
                                children: [
                                    {
                                        ...
                                        align: 'center',
                                        render: function (h, params) { return h('sgc_caowg_match_itable1_1', { props: { params: params, page: page } }); }
